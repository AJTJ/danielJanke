...
?> 
 ...
 {	
	...
	*/
	...
	add_settings_field(           
		 'artist_slug',
		 esc_html__('Artist Post Type Slug', 'lucille-music-core'),
		 'LMC_plugin_options_artist_slug_callback',
		 'LMC_plugin_options',
		 'LMC_plugin_section'
	 );	
	...
	*/
	...
	add_settings_field(           
		'artist_tax_slug',
		esc_html__('Artist Category Slug', 'lucille-music-core'),
		'LMC_plugin_options_artist_tax_slug_callback',
		'LMC_plugin_options',
		'LMC_plugin_section'
	);	
...
function LMC_plugin_options_artist_slug_callback() {
	$options = get_option( 'LMC_plugin_options' );  
	...
	echo '<input type="text" size="50 id="artist" name="LMC_plugin_options[artist]" value="' . esc_attr($slug) . '" />';  
}
...
function LMC_plugin_options_artist_tax_slug_callback() {
	$options = get_option( 'LMC_plugin_options' );
	...
	echo '<input type="text" size="50 id="artist_tax" name="LMC_plugin_options[artist_tax]" value="' . esc_attr($slug) . '" />'; 	
}
