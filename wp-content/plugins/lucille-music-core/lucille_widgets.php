...
function LUCILLE_SWP_register_widget_rpwi() {
	return register_widget("LUCILLE_SWP_recent_posts_with_images");
}
add_action('widgets_init', "LUCILLE_SWP_register_widget_rpwi");
...
function LUCILLE_SWP_register_widget_next_events() {
	return register_widget("LUCILLE_SWP_next_events");
}
add_action('widgets_init', "LUCILLE_SWP_register_widget_next_events");
...
class LUCILLE_SWP_contact_data extends WP_Widget {
	...
	public function widget($args, $instance) {
		...
		if (function_exists("LUCILLE_SWP_get_2nd_contact_phone")) {
...
function LUCILLE_SWP_register_widget_contact_data() {
	return register_widget("LUCILLE_SWP_contact_data");
}
add_action('widgets_init', "LUCILLE_SWP_register_widget_contact_data");
...
function LUCILLE_SWP_register_widget_gallery() {
	return register_widget("LUCILLE_SWP_gallery_widget");
}
add_action('widgets_init', "LUCILLE_SWP_register_widget_gallery");
