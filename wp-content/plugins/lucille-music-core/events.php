...
function LUCILLE_SWP_display_events_meta_box($eventObject) {
	...
	$link_target_opts = array(
		esc_html__('Same Browser Window', 'lucille-music-core')	=> '_self',
		esc_html__('New Browser Tab', 'lucille-music-core')	=> '_blank'
	);	
?>
    ...
    <table style= "width: 100%;">
       <tr >
			...
			<td ><input class="swp_datepicker event_date_input" style="width: 100%;  display: block;" type="text" name="event_date" value="<?php echo esc_attr($event_date); ?>" />
				<div style="color: #999999; font-size: 0.9em; margin-bottom: 5px;"><?php echo esc_html__('The Date for Event YYYY/MM/DD','lucille-music-core'); ?></div>
			</td>
        </tr>	
        <tr >
            ...
            <td ><input id="timepicker" style="width: 100%;  display: block;" type="text" name="event_time" value="<?php echo esc_attr($event_time); ?>" />
				<div style="color: #999999; font-size: 0.9em; margin-bottom: 5px;"><?php echo esc_html__('Event Time hh:mm','lucille-music-core'); ?></div>
			</td>
        </tr>
        <tr>
        	<td style= "width: 30%;"><?php echo esc_html__('Multi-Day Event','lucille-music-core');?></td>
        	<td>
        		<input name="event_multiday" class="event_multiday_check" type="checkbox" value="1" <?php checked("1", $event_multiday); ?>>
        		<div style="color: #999999; font-size: 0.9em; margin-bottom: 5px;"><?php echo esc_html__('Check this ONLY if this is a multi day event.','lucille-music-core'); ?></div>
        	</td>
        </tr>
       	<tr class="event_end_date_container">
            <td style= "width: 30%;"><?php echo esc_html__('Event End Date','lucille-music-core');?></td>
			<td>
				...
				<div style="color: #999999; font-size: 0.9em; margin-bottom: 5px;">
					<?php echo esc_html__('The End Date for the Multi Day Event YYYY/MM/DD','lucille-music-core'); ?>
				</div>
			</td>
        </tr>        
        <tr >
            ...
            <td ><input style="width: 100%;  display: block;" type="text" name="event_venue" value="<?php echo esc_attr($event_venue); ?>" />
				<div style="color: #999999; font-size: 0.9em; margin-bottom: 5px;"><?php echo esc_html__('Venue ex. Glastonbury Festival','lucille-music-core'); ?></div>
			</td>
        </tr>
        <tr >
            ...
            <td ><input style="width: 100%;  display: block;" type="text" name="event_venue_url" value="<?php echo esc_attr($event_venue_url); ?>" />
				<div style="color: #999999; font-size: 0.9em; margin-bottom: 5px;"><?php echo esc_html__('Venue URL ex. http://www.glastonburyfestivals.co.uk/','lucille-music-core'); ?></div>
			</td>
        </tr>

        <tr>
        	<td style= "width: 30%;"><?php echo esc_html__('Open Venue Link In','lucille-music-core');?></td>
        	<td>
        		...
        		<div style="color: #999999; font-size: 0.9em; margin-bottom: 5px;">
	        		<?php echo esc_html__('Choose to open venue link in self window or in a new tab.', 'lucille-music-core'); ?>
        		</div>
        	</td>
        </tr>
        ...
        <tr >
            ...
            <td ><input style="width: 100%;  display: block;" type="text" name="event_location" value="<?php echo esc_attr($event_location); ?>" />
				<div style="color: #999999; font-size: 0.9em; margin-bottom: 5px;"><?php echo esc_html__('Event Location ex. Worthy Farm, Pilton GB','lucille-music-core'); ?></div>
			</td>
        </tr>		
        ...
        <tr >
            ...
            <td ><input  style="width: 100%;  display: block;" type="text" name="event_buy_tickets_message" value="<?php echo esc_attr($event_buy_tickets_message); ?>" />
				<div style="color: #999999; font-size: 0.9em; margin-bottom: 5px;"><?php echo esc_html__('ex. [Buy Tickets From] or [Free Entry]','lucille-music-core'); ?></div>
			</td>
        </tr>		
        <tr >
            ...
            <td ><input style="width: 100%;  display: block;" type="text" name="event_buy_tickets_url" value="<?php echo esc_attr($event_buy_tickets_url); ?>" />
				<div style="color: #999999; font-size: 0.9em; margin-bottom: 5px;"><?php echo esc_html__('ex. http://www.ticketmaster.com/','lucille-music-core'); ?></div>
			</td>
        </tr>		
        <tr>
        	<td style= "width: 30%;"><?php echo esc_html__('Open Tickets Link In','lucille-music-core');?></td>
        	<td>
        		...
        		<div style="color: #999999; font-size: 0.9em; margin-bottom: 5px;">
	        		<?php echo esc_html__('Choose to open tickets link in self window or in a new tab.', 'lucille-music-core'); ?>
        		</div>
        	</td>
        </tr>        
        <tr >
            ...
            <td ><input  style="width: 100%;  display: block;" type="text" name="event_fb_message" value="<?php echo esc_attr($event_fb_message); ?>" />
				<div style="color: #999999; font-size: 0.9em; margin-bottom: 5px;"><?php echo esc_html__('ex. Check event on Facebook','lucille-music-core'); ?></div>
			</td>
        </tr>		
        <tr >
            ...
            <td ><input  style="width: 100%;  display: block;" type="text" name="event_fb_url" value="<?php echo esc_attr($event_fb_url); ?>" />
				<div style="color: #999999; font-size: 0.9em; margin-bottom: 5px;"><?php echo esc_html__('URL to Facebook Event Page','lucille-music-core'); ?></div>
			</td>
        </tr>		
        <tr >
            ...
            ?>
				...
				<div style="color: #999999; font-size: 0.9em; margin-bottom: 5px;"><?php echo esc_html__('Embedded code ex. &lt;iframe src="https://www.google.com/maps/embed?pb=.." &gt;&lt;/iframe&gt;','lucille-music-core'); ?></div>
			</td>
        </tr>		
        <tr >
            ...
            <td ><input  style="width: 100%;  display: block;" type="text" name="event_youtube_url" value="<?php echo esc_attr($event_youtube_url); ?>" />
				<div style="color: #999999; font-size: 0.9em; margin-bottom: 5px;"><?php echo esc_html__('URL to Promo Video on Youtube','lucille-music-core'); ?></div>
			</td>
        </tr>		
        <tr >
            ...
            <td ><input  style="width: 100%;  display: block;" type="text" name="event_vimeo_url" value="<?php echo esc_attr($event_vimeo_url); ?>" />
				<div style="color: #999999; font-size: 0.9em; margin-bottom: 5px;"><?php echo esc_html__('URL to Promo Video on Vimeo','lucille-music-core'); ?></div>
			</td>
        </tr>	
	</table>
